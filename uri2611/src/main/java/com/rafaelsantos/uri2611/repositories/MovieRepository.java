package com.rafaelsantos.uri2611.repositories;
...
import com.rafaelsantos.uri2611.dto.MovieMinDTO;
import com.rafaelsantos.uri2611.entities.Movie;
...
public interface MovieRepository extends JpaRepository<Movie, Long>{
	...
	@Query("SELECT new com.rafaelsantos.uri2611.dto.MovieMinDTO(obj.id, obj.name) "
			+ "FROM Movie obj "
